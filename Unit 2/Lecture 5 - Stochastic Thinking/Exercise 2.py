...
# To test this code yourself, put the line import random at the top of your code file, 
# to import all of the functions in the random module. To call random module methods, 
